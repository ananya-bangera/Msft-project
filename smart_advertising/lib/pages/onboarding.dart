      ...
      body: SafeArea(
        child: IntroductionScreen(
          ...
          pages: [
            PageViewModel(
              title: "AdvertAIse",
              body: "A platform for companies to utilize smart advertising techniques to analyze and improve their advertisements based on user inputs",
            ...
            PageViewModel(
              title: "Our Motto",
              body: "Help them to make their advertisements more engaging thereby ensuring a better and effective reach of their advertisement",
